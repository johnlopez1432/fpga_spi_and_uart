...
# #Sch name = JB3
# set_property PACKAGE_PIN B15 [get_ports {JB_IN}]					
# 	set_property IOSTANDARD LVCMOS33 [get_ports {JB_IN}]
# #Sch name = JB4
# set_property PACKAGE_PIN B16 [get_ports {JB_OUT[2]}]					
# 	set_property IOSTANDARD LVCMOS33 [get_ports {JB_OUT[2]}]
# #Sch name = JB7
# set_property PACKAGE_PIN A15 [get_ports {JB_OUT[3]}]					
# 	set_property IOSTANDARD LVCMOS33 [get_ports {JB_OUT[3]}]
# #Sch name = JB8
# set_property PACKAGE_PIN A17 [get_ports {JB_OUT[4]}]					
# 	set_property IOSTANDARD LVCMOS33 [get_ports {JB_OUT[4]}]
# #Sch name = JB9
# set_property PACKAGE_PIN C15 [get_ports {JB_OUT[5]}]					
# 	set_property IOSTANDARD LVCMOS33 [get_ports {JB_OUT[5]}]
# #Sch name = JB10 
# set_property PACKAGE_PIN C16 [get_ports {JB_OUT[6]}]					
# 	set_property IOSTANDARD LVCMOS33 [get_ports {JB_OUT[6]}]
